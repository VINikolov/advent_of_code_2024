...
// mod day_six_solution;
mod day_seven_solution;
...
// use crate::day_six_solution::solve_day_six;
use crate::day_seven_solution::solve_day_seven;

fn main() {
    let (answer_one, answer_two) = solve_day_seven();
